...
class CMAContainerTracking:
    """
    Handle container tracking operations, including opening the tracking page,
    downloading PDFs, and extracting details from them.
    """
    
    def __init__(self, browser, download_folder):
        """
        Initializes the CMA tracker with a shared browser instance and download folder.
        Args:
    ...
    def open_tracking_page(self, container_number):
